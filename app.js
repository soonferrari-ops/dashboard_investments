...
function renderImportTable(positions) {
  ...
  if (emptyTickers > 0) {
    title.textContent += ' · ⚠️ ' + emptyTickers + ' ' + t('tickersPorPreencher');
  }
